...
public class RemoteControl extends ioResource implements IHCResource, java.io.Serializable {
		...
		try 
		{
			...
			while(tagname != endTag)
			{
				...
				else if(tagname.equals("airlink_input"))
				{
					...
					else if(xpp.getAttributeValue(null,"address_channel").equals("_0x7"))
						this.seven =  Integer.parseInt(val.replace("_0x", ""), 16);
					else if(xpp.getAttributeValue(null,"address_channel").equals("_0x8"))
