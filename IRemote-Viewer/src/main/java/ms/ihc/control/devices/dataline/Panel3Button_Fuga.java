...
public class Panel3Button_Fuga extends ioResource implements IHCResource, java.io.Serializable {
	...
	public View getView(LayoutInflater layoutInf, ConnectionManager ihcCtrl) {
        ...
        holder.button3.setText(R.string.lowerleft);
        holder.button3.setTag(ihcCtrl);
        holder.button4.setText(R.string.lowerright);
